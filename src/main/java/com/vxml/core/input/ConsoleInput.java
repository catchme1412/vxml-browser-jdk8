...
public class ConsoleInput {
    ...
    public String readLine() throws VxmlNoInputEvent {
...
//                System.out.println(String.valueOf(i + 1) + ". loop");
    ...
    public static void main(String[] args) throws InterruptedException, VxmlNoInputEvent {
